...
const tileCoordinatesSources: Record<number, () => Set<string>> = {
    ...
    // biome-ignore format:
    5: () => new Set(['-7:7', '-7:6', '-6:6', '-6:7', '-7:8', '-8:8', '-8:7', '-6:5', '-5:5', '-5:6', '-5:7', '-6:8', '-7:9', '-8:9', '-9:9', '-9:8', '-9:7', '-8:6', '-7:5', '-6:4', '-5:4', '-4:4', '-4:5', '-4:6', '-4:7', '-5:8', '-6:9',  '-8:10', '-9:10', '-10:9', '-10:8', '-10:7', '-9:6', '-8:5', '-7:4', '-7:10']).difference(tileCoordinatesSources[0]()),
    // biome-ignore format:
    6: () => new Set(['7:-7', '7:-8', '8:-8', '8:-7', '7:-6', '6:-6', '6:-7', '8:-9', '9:-9', '9:-8', '9:-7', '8:-6', '7:-5', '6:-5', '5:-5', '5:-6', '5:-7', '6:-8', '7:-9', '8:-10', '9:-10', '10:-9', '10:-8', '9:-6', '8:-5', '7:-4', '6:-4', '5:-4', '4:-4', '4:-5', '4:-6', '4:-7', '5:-8', '6:-9', '7:-10', '10:-7']).difference(tileCoordinatesSources[0]()),
};
